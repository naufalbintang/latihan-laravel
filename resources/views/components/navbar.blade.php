    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
        ...
        <div class="border-t border-white/10 pt-4 pb-3">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base/5 font-medium text-white">Naufal Bintang Pradana Himawan</div>
                    <div class="text-sm font-medium text-gray-400">naufalbintangpradana@gmail.com</div>
                </div>
            </div>
